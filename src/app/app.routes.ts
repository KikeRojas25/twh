...
export const appRoutes: Route[] = [
    ...
    // Redirect empty path to '/inicio' (Pantalla inicial)
    // Note: The route is protected by AuthGuard in Admin routes section
    {path: '', pathMatch : 'full', redirectTo: 'inicio'},

    // Redirect signed-in user to the inicio page
    //
    ...
    // Admin routes
    {
        ...
        children: [
            {
                path: 'inicio',
                loadComponent: () => import('app/modules/admin/inicio/inicio.component')
            ...
            },
            {
              ...
              },
              {
                ...
                children: [
                  ...
                  {
                    path: 'areas',
                    loadComponent: () => import('./modules/admin/mantenimientos/areas/list/list.component')
                                          .then(m => m.ListAreasComponent)
                  },
                  {
                    path: 'listadoubicaciones',
                    loadComponent: () => import('./modules/admin/mantenimientos/ubicaciones/list/list.component')
                                          .then(m => m.ListUbicacionesComponent)
                  },
                  {
                    path: 'listadocliente',
