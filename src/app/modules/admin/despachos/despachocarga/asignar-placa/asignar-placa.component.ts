...
@Component({
  selector: 'app-asignar-placa',
  templateUrl: './asignar-placa.component.html',
  styleUrls: ['./asignar-placa.component.css'],
    standalone: true,
    imports: [
      CommonModule,
      FormsModule,
...
export class AsignarPlacaComponent implements OnInit {
  ...
  public asignarConductor(): void {
    ...
    this.commonService.registrarEquipoTransporte( this.id, this.selectedTracto.id
